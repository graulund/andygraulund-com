...
<figure class="figure-charts">
	...
	<figcaption><strong class="figcaption-prefix">Demo:</strong> This shows the number of times tracks by The Weekend were played on a major Danish radio channel per day in winter 2021. <strong>Move your mouse over the titles to highlight a specific track</strong></figcaption>
</figure>
